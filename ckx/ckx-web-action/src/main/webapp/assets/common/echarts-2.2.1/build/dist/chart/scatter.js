define("echarts/chart/scatter", ["require", "./base", "../util/shape/Symbol", "../component/axis", "../component/grid", "../component/dataZoom", "../component/dataRange", "../config", "zrender/tool/util", "zrender/tool/color", "../chart"], function (e) {
    ...
    return t.prototype = {
        type: r.COMPONENT_TYPE_DATARANGE, _textGap: 10, _buildShape: function () {
            ...
            var e, t, i, o, r = this._valueTextList, s = r.length, l = this.getFont(this.dataRangeOption.textStyle), d = this._itemGroupLocation.x, c = this._itemGroupLocation.y, m = this.dataRangeOption.itemWidth, p = this.dataRangeOption.itemHeight, u = this.dataRangeOption.itemGap, V = h.getTextHeight("国", l);
            ...
            var g = !0;
            this.dataRangeOption.text && (g = !1, this.dataRangeOption.text[0] && (i = this._getTextShape(d, c, this.dataRangeOption.text[0]), "horizontal" == this.dataRangeOption.orient ? d += h.getTextWidth(this.dataRangeOption.text[0], l) + this._textGap : (c += V + this._textGap, i.style.y += V / 2 + this._textGap, i.style.textBaseline = "bottom"), this.shapeList.push(new n(i))));
            for (var U = 0; s > U; U++)e = r[U], o = this.getColorByIndex(U), t = this._getItemShape(d, c, m, p, this._selectedMap[U] ? o : "#ccc"), t._idx = U, t.onmousemove = this._dispatchHoverLink, this.dataRangeOption.selectedMode && (t.clickable = !0, t.onclick = this._dataRangeSelected), this.shapeList.push(new a(t)), g && (i = {
                zlevel: this.getZlevelBase(),
                z: this.getZBase(),
                style: {
                    x: d + m + 5,
            ...
            }, "vertical" == this.dataRangeOption.orient && "right" == this.dataRangeOption.x && (i.style.x -= m + 10, i.style.textAlign = "right"), i._idx = U, i.onmousemove = this._dispatchHoverLink, this.dataRangeOption.selectedMode && (i.clickable = !0, i.onclick = this._dataRangeSelected), this.shapeList.push(new n(i))), "horizontal" == this.dataRangeOption.orient ? d += m + (g ? 5 : 0) + (g ? h.getTextWidth(e, l) : 0) + u : c += p + u;
            !g && this.dataRangeOption.text[1] && ("horizontal" == this.dataRangeOption.orient ? d = d - u + this._textGap : c = c - u + this._textGap, i = this._getTextShape(d, c, this.dataRangeOption.text[1]), "horizontal" != this.dataRangeOption.orient && (i.style.y -= 5, i.style.textBaseline = "top"), this.shapeList.push(new n(i)))
            ...
            for (var u = e("zrender/tool/color"), V = 1 / (this.dataRangeOption.color.length - 1), g = [], U = 0, y = this.dataRangeOption.color.length; y > U; U++)g.push([U * V, this.dataRangeOption.color[U]]);
            "horizontal" == this.dataRangeOption.orient ? (t = {
                zlevel: this.getZlevelBase(),
                z: this.getZBase(),
                style: {x: r, y: s, width: l * m, height: d, color: u.getLinearGradient(r, s, r + l * m, s, g)},
                hoverable: !1
            }, r += l * m + this._textGap) : (t = {
                zlevel: this.getZlevelBase(),
                z: this.getZBase(),
                style: {x: r, y: s, width: l, height: d * m, color: u.getLinearGradient(r, s, r, s + d * m, g)},
                hoverable: !1
            ...
            var e, t, i, n, a, r, s, l, d = this._calculableLocation.x, c = this._calculableLocation.y, m = this._calculableLocation.width, p = this._calculableLocation.height, u = this.getFont(this.dataRangeOption.textStyle), V = h.getTextHeight("国", u), g = Math.max(h.getTextWidth(this._textFormat(this.dataRangeOption.max), u), h.getTextWidth(this._textFormat(this.dataRangeOption.min), u)) + 2;
            "horizontal" == this.dataRangeOption.orient ? "bottom" != this.dataRangeOption.y ? (e = [[d, c], [d, c + p + V], [d - V, c + p + V], [d - 1, c + p], [d - 1, c]], t = d - g / 2 - V, i = c + p + V / 2 + 2, n = {
                x: d - g - V,
                y: c + p,
                width: g + V,
                height: V
            }, a = [[d + m, c], [d + m, c + p + V], [d + m + V, c + p + V], [d + m + 1, c + p], [d + m + 1, c]], r = d + m + g / 2 + V, s = i, l = {
                x: d + m,
                y: c + p,
                width: g + V,
                height: V
            }) : (e = [[d, c + p], [d, c - V], [d - V, c - V], [d - 1, c], [d - 1, c + p]], t = d - g / 2 - V, i = c - V / 2 - 2, n = {
                x: d - g - V,
                y: c - V,
                width: g + V,
                height: V
            }, a = [[d + m, c + p], [d + m, c - V], [d + m + V, c - V], [d + m + 1, c], [d + m + 1, c + p]], r = d + m + g / 2 + V, s = i, l = {
                x: d + m,
                y: c - V,
                width: g + V,
                height: V
            }) : (g += V, "right" != this.dataRangeOption.x ? (e = [[d, c], [d + m + V, c], [d + m + V, c - V], [d + m, c - 1], [d, c - 1]], t = d + m + g / 2 + V / 2, i = c - V / 2, n = {
                x: d + m,
                y: c - V,
                width: g + V,
                height: V
            }, a = [[d, c + p], [d + m + V, c + p], [d + m + V, c + V + p], [d + m, c + 1 + p], [d, c + p + 1]], r = t, s = c + p + V / 2, l = {
                x: d + m,
                y: c + p,
                width: g + V,
                height: V
            }) : (e = [[d + m, c], [d - V, c], [d - V, c - V], [d, c - 1], [d + m, c - 1]], t = d - g / 2 - V / 2, i = c - V / 2, n = {
                x: d - g - V,
                y: c - V,
                width: g + V,
                height: V
            }, a = [[d + m, c + p], [d - V, c + p], [d - V, c + V + p], [d, c + 1 + p], [d + m, c + p + 1]], r = t, s = c + p + V / 2, l = {
                x: d - g - V,
                y: c + p,
                width: g + V,
                height: V
            ...
            if ("horizontal" == this.dataRangeOption.orient) {
                if (this.dataRangeOption.text || this.dataRangeOption.splitNumber <= 0 || this.dataRangeOption.calculable)o = (this.dataRangeOption.splitNumber <= 0 || this.dataRangeOption.calculable ? n * d + i : t * (n + i)) + (this.dataRangeOption.text && "undefined" != typeof this.dataRangeOption.text[0] ? h.getTextWidth(this.dataRangeOption.text[0], s) + this._textGap : 0) + (this.dataRangeOption.text && "undefined" != typeof this.dataRangeOption.text[1] ? h.getTextWidth(this.dataRangeOption.text[1], s) + this._textGap : 0); else {
                    n += 5;
            ...
            var p, u = this.reformCssArray(this.dataRangeOption.padding), V = this.zr.getWidth();
            switch (this.dataRangeOption.x) {
                ...
                case"left":
                    ...
                    break;
                case"right":
                    p = V - o - u[1] - this.dataRangeOption.borderWidth;
                    break;
                default:
                    p = this.parsePercent(this.dataRangeOption.x, V), p = isNaN(p) ? 0 : p
            }
            var g, U = this.zr.getHeight();
            switch (this.dataRangeOption.y) {
                case"top":
                    g = u[0] + this.dataRangeOption.borderWidth;
                    break;
                case"bottom":
                    g = U - r - u[2] - this.dataRangeOption.borderWidth;
                    break;
                case"center":
                    g = Math.floor((U - r) / 2);
                    break;
                default:
                    g = this.parsePercent(this.dataRangeOption.y, U), g = isNaN(g) ? 0 : g
            }
            if (this.dataRangeOption.calculable) {
                var y = Math.max(h.getTextWidth(this.dataRangeOption.max, s), h.getTextWidth(this.dataRangeOption.min, s)) + l;
                "horizontal" == this.dataRangeOption.orient ? (y > p && (p = y), p + o + y > V && (p -= y)) : (l > g && (g = l), g + r + l > U && (g -= l))
            }
            return {x: p, y: g, width: o, height: r}
            ...
            var n = (this._colorList.length - i) * this._gap + this.dataRangeOption.min;
            this.messageCenter.dispatch(r.EVENT.DATA_RANGE_SELECTED, e.event, {
                selected: this._selectedMap,
                target: i,
                valueMax: n,
                valueMin: n - this._gap
