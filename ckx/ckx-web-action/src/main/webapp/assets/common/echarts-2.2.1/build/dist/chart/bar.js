        ...
        type: a.CHART_TYPE_BAR, _buildShape: function () {
            ...
            for (var s, l, h, d, m, c, p, u, V, U, g, y, f = this.series, b = i[0][0], _ = f[b], x = "horizontal" == r, k = this.component.xAxis, L = this.component.yAxis, v = x ? k.getAxis(_.xAxisIndex) : L.getAxis(_.yAxisIndex), W = this._mapSize(v, i), w = W.gap, X = W.barGap, I = W.barWidthMap, K = W.barMaxWidthMap, S = W.barWidth, C = W.barMinHeightMap, T = W.interval, E = this.deepQuery([this.ecTheme, a], "island.r"), z = 0, A = t; A > z && null != v.getNameByIndex(z); z++) {
                ...
                for (var M = 0, J = i.length; J > M; M++) {
                    var F = f[i[M][0]].yAxisIndex || 0, O = f[i[M][0]].xAxisIndex || 0;
            ...
            for (var o = this.series, r = 0, s = i.length; s > r; r++)for (var l = 0, h = i[r].length; h > l; l++) {
                var d = i[r][l], m = o[d], c = m.xAxisIndex || 0, p = this.component.xAxis.getAxis(c), u = p.getCoord(0), V = m.yAxisIndex || 0, U = this.component.yAxis.getAxis(V), g = U.getCoord(0);
                a[d] = a[d] || {
                ...
                for (var y = 0, f = m.data.length; f > y; y++) {
                    var b = m.data[y], _ = this.getDataFromOption(b, "-");
            ...
            if (t.length != h) {
                if (i)n = e.getGap(), m = 0, a = +(n / t.length).toFixed(2), 0 >= a && (p = Math.floor(t.length / n), a = 1); else if (n = "string" == typeof c && c.match(/%$/) ? (e.getGap() * (100 - parseFloat(c)) / 100).toFixed(2) - 0 : e.getGap() - c, "string" == typeof m && m.match(/%$/) ? (m = parseFloat(m) / 100, a = +((n - d) / ((t.length - 1) * m + t.length - h)).toFixed(2), m = a * m) : (m = parseFloat(m), a = +((n - d - m * (t.length - 1)) / (t.length - h)).toFixed(2)), 0 >= a)return this._mapSize(e, t, !0)
            ...
            for (var i, n, a, o, r = this.series, s = {}, l = {}, h = {}, d = 0, m = 0, c = 0, p = e.length; p > c; c++)for (var u = {
                ...
                var g = e[c][V], y = r[g];
                if (!t) {
                    if (u.barWidth)s[g] = i; else if (i = this.query(y, "barWidth"), null != i) {
                    ...
                    if (u.barMaxWidth)l[g] = n; else if (n = this.query(y, "barMaxWidth"), null != n) {
            ...
            var d, m = this.series, c = m[e], p = c.data[t], u = this._sIndex2ColorMap[e], V = [p, c], U = this.deepMerge(V, "itemStyle.normal"), g = this.deepMerge(V, "itemStyle.emphasis"), y = U.barBorderWidth;
            d = {
            ...
            for (var l, h, d, m, c, p, u, V = 0, r = this.shapeList.length - 1; r >= 0; r--)if (p = o.get(this.shapeList[r], "seriesIndex"), a[p] && !a[p][3] && "rectangle" === this.shapeList[r].type) {
