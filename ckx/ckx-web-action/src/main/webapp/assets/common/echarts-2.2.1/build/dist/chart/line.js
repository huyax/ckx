define("echarts/chart/line", ["require", "./base", "zrender/shape/Polyline", "../util/shape/Icon", "../util/shape/HalfSmoothPolygon", "../component/axis", "../component/grid", "../component/dataZoom", "../config", "../util/ecData", "zrender/tool/util", "zrender/tool/color", "../chart"], function (e) {
    ...
    return t.prototype = {
        type: s.CHART_TYPE_LINE, _buildShape: function () {
            ...
            for (var a, o, r, s, l, h, d, m, c, p = this.series, u = i[0][0], V = p[u], U = this.component.xAxis.getAxis(V.xAxisIndex || 0), g = {}, y = 0, f = t; f > y && null != U.getNameByIndex(y); y++) {
                o = U.getCoordByIndex(y);
                for (var b = 0, _ = i.length; _ > b; b++) {
                    a = this.component.yAxis.getAxis(p[i[b][0]].yAxisIndex || 0), l = s = d = h = a.getCoord(0);
                    for (var x = 0, k = i[b].length; k > x; x++)u = i[b][x], V = p[u], m = V.data[y], c = this.getDataFromOption(m, "-"), g[u] = g[u] || [], n[u] = n[u] || {
                            min: Number.POSITIVE_INFINITY,
                            max: Number.NEGATIVE_INFINITY,
                            sum: 0,
                            counter: 0,
                            average: 0
                        }, "-" !== c ? (c >= 0 ? (s -= x > 0 ? a.getCoordSize(c) : l - a.getCoord(c), r = s) : 0 > c && (h += x > 0 ? a.getCoordSize(c) : a.getCoord(c) - d, r = h), g[u].push([o, r, y, U.getNameByIndex(y), o, l]), n[u].min > c && (n[u].min = c, n[u].minY = r, n[u].minX = o), n[u].max < c && (n[u].max = c, n[u].maxY = r, n[u].maxX = o), n[u].sum += c, n[u].counter++) : g[u].length > 0 && (this.finalPLMap[u] = this.finalPLMap[u] || [], this.finalPLMap[u].push(g[u]), g[u] = [])
                }
                s = this.component.grid.getY();
                for (var L, b = 0, _ = i.length; _ > b; b++)for (var x = 0, k = i[b].length; k > x; x++)u = i[b][x], V = p[u], m = V.data[y], c = this.getDataFromOption(m, "-"), "-" == c && this.deepQuery([m, V, this.option], "calculable") && (L = this.deepQuery([m, V], "symbolSize"), s += 2 * L + 5, r = s, this.shapeList.push(this._getCalculableItem(u, y, U.getNameByIndex(y), o, r, "horizontal")))
            }
            for (var v in g)g[v].length > 0 && (this.finalPLMap[v] = this.finalPLMap[v] || [], this.finalPLMap[v].push(g[v]), g[v] = []);
            this._calculMarkMapXY(n, i, "y"), this._buildBorkenLine(e, this.finalPLMap, U, "horizontal")
        }, _buildVertical: function (e, t, i, n) {
            for (var a, o, r, s, l, h, d, m, c, p = this.series, u = i[0][0], V = p[u], U = this.component.yAxis.getAxis(V.yAxisIndex || 0), g = {}, y = 0, f = t; f > y && null != U.getNameByIndex(y); y++) {
                r = U.getCoordByIndex(y);
                for (var b = 0, _ = i.length; _ > b; b++) {
                    ...
                    for (var x = 0, k = i[b].length; k > x; x++)u = i[b][x], V = p[u], m = V.data[y], c = this.getDataFromOption(m, "-"), g[u] = g[u] || [], n[u] = n[u] || {
                            ...
                            counter: 0,
                            average: 0
                        }, "-" !== c ? (c >= 0 ? (s += x > 0 ? a.getCoordSize(c) : a.getCoord(c) - l, o = s) : 0 > c && (h -= x > 0 ? a.getCoordSize(c) : d - a.getCoord(c), o = h), g[u].push([o, r, y, U.getNameByIndex(y), l, r]), n[u].min > c && (n[u].min = c, n[u].minX = o, n[u].minY = r), n[u].max < c && (n[u].max = c, n[u].maxX = o, n[u].maxY = r), n[u].sum += c, n[u].counter++) : g[u].length > 0 && (this.finalPLMap[u] = this.finalPLMap[u] || [], this.finalPLMap[u].push(g[u]), g[u] = [])
                }
                s = this.component.grid.getXend();
                for (var L, b = 0, _ = i.length; _ > b; b++)for (var x = 0, k = i[b].length; k > x; x++)u = i[b][x], V = p[u], m = V.data[y], c = this.getDataFromOption(m, "-"), "-" == c && this.deepQuery([m, V, this.option], "calculable") && (L = this.deepQuery([m, V], "symbolSize"), s -= 2 * L + 5, o = s, this.shapeList.push(this._getCalculableItem(u, y, U.getNameByIndex(y), o, r, "vertical")))
            }
            for (var v in g)g[v].length > 0 && (this.finalPLMap[v] = this.finalPLMap[v] || [], this.finalPLMap[v].push(g[v]), g[v] = []);
            ...
            for (var a, o = this.series, r = {}, s = 0, l = i.length; l > s; s++)for (var h = 0, d = i[s].length; d > h; h++) {
                var m = i[s][h], c = o[m];
                a = this.component.xAxis.getAxis(c.xAxisIndex || 0);
                var p = this.component.yAxis.getAxis(c.yAxisIndex || 0), u = p.getCoord(0);
                r[m] = r[m] || [], n[m] = n[m] || {
                ...
                for (var V = 0, U = c.data.length; U > V; V++) {
                    var g = c.data[V], y = this.getDataFromOption(g, "-");
                    if (y instanceof Array) {
                        var f = a.getCoord(y[0]), b = p.getCoord(y[1]);
                        r[m].push([f, b, V, y[0], f, u]), n[m].min0 > y[0] && (n[m].min0 = y[0], n[m].minY0 = b, n[m].minX0 = f), n[m].max0 < y[0] && (n[m].max0 = y[0], n[m].maxY0 = b, n[m].maxX0 = f), n[m].sum0 += y[0], n[m].counter0++, n[m].min1 > y[1] && (n[m].min1 = y[1], n[m].minY1 = b, n[m].minX1 = f), n[m].max1 < y[1] && (n[m].max1 = y[1], n[m].maxY1 = b, n[m].maxX1 = f), n[m].sum1 += y[1], n[m].counter1++
                    }
                }
            }
            ...
            for (var o, s = "other" == n ? "horizontal" : n, m = this.series, c = e.length - 1; c >= 0; c--) {
                var p = e[c], u = m[p], V = t[p];
                if (u.type === this.type && null != V)for (var U = this._getBbox(p, s), g = this._sIndex2ColorMap[p], y = this.query(u, "itemStyle.normal.lineStyle.width"), f = this.query(u, "itemStyle.normal.lineStyle.type"), b = this.query(u, "itemStyle.normal.lineStyle.color"), _ = this.getItemStyleColor(this.query(u, "itemStyle.normal.color"), p, -1), x = null != this.query(u, "itemStyle.normal.areaStyle"), k = this.query(u, "itemStyle.normal.areaStyle.color"), L = 0, v = V.length; v > L; L++) {
                    var W = V[L], w = "other" != n && this._isLarge(s, W);
                    ...
                    if (l.pack(K, m[p], p, 0, L, m[p].name), this.shapeList.push(K), x) {
                        var S = new r({
                            zlevel: this.getZlevelBase(),
                            z: this.getZBase(),
                            style: {
                        ...
                        l.pack(S, m[p], p, 0, L, m[p].name), this.shapeList.push(S)
                    }
                }
            }
            ...
            for (var r = [], s = 0; n > s; s++) {
                ...
                if (!(l >= h)) {
                    ...
                    r.length = h - l;
                    for (var m = i(r), c = -1, p = 1 / 0, d = l; h > d; d++) {
                        var u = "horizontal" === e ? t[d][1] : t[d][0], V = Math.abs(u - m);
                        p > V && (c = d, p = V)
                    }
                    var U = t[c].slice();
                    "horizontal" === e ? U[1] = m : U[0] = m, o.push(U)
                }
            }
            return o
            ...
            for (var l, h, d, m, c, p, u, V = 0, r = this.shapeList.length - 1; r >= 0; r--)if (c = this.shapeList[r]._seriesIndex, o[c] && !o[c][3]) {
                if (this.shapeList[r]._main && this.shapeList[r].style.pointList.length > 1) {
                    if (p = this.shapeList[r].style.pointList, h = Math.abs(p[0][0] - p[1][0]), m = Math.abs(p[0][1] - p[1][1]), u = "horizontal" === this.shapeList[r]._orient, o[c][2]) {
                        ...
                        this.shapeList[r].style.pointList.pop(), u ? (l = h, d = 0) : (l = 0, d = -m)
                    } else {
                    ...
                    if (o[c][2] && this.shapeList[r]._dataIndex === a[c].data.length - 1) {
                        this.zr.delShape(this.shapeList[r].id);
                        continue
                    }
                    if (!o[c][2] && 0 === this.shapeList[r]._dataIndex) {
                        this.zr.delShape(this.shapeList[r].id);
                        continue
                    }
                }
