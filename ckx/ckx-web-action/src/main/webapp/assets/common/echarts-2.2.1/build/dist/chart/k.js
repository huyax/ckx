define("echarts/chart/k", ["require", "./base", "../util/shape/Candle", "../component/axis", "../component/grid", "../component/dataZoom", "../config", "../util/ecData", "zrender/tool/util", "../chart"], function (e) {
    ...
    return t.prototype = {
        type: a.CHART_TYPE_K, _buildShape: function () {
            ...
            for (var n, a, o, r, s, l, h, d, c, m, p = this.series, u = {}, V = 0, g = i.length; g > V; V++) {
                n = i[V], a = p[n], o = a.xAxisIndex || 0, r = this.component.xAxis.getAxis(o), h = a.barWidth || Math.floor(r.getGap() / 2), m = a.barMaxWidth, m && h > m && (h = m), s = a.yAxisIndex || 0, l = this.component.yAxis.getAxis(s), u[n] = [];
            ...
            for (var i, n, o, r, s, l, h, d, c, m, p, u, V, g, U, y, f, _ = this.series, b = 0, x = e.length; x > b; b++)if (f = e[b], p = _[f], g = t[f], this._isLarge(g) && (g = this._getLargePointList(g)), p.type === a.CHART_TYPE_K && null != g) {
            ...
            return n
        }, _getCandle: function (e, t, i, a, r, s, l, h, d, c, m, p, u, V, g) {
            var U = this.series, y = U[e], f = y.data[t], _ = [f, y], b = {
                ...
                highlightStyle: {color: u, strokeColor: g, lineWidth: V},
                _seriesIndex: e
            };
