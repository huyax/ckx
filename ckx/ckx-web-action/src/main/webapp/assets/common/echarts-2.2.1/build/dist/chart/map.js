define("echarts/chart/map", ["require", "./base", "zrender/shape/Text", "zrender/shape/Path", "zrender/shape/Circle", "zrender/shape/Rectangle", "zrender/shape/Line", "zrender/shape/Polygon", "zrender/shape/Ellipse", "../component/dataRange", "../component/roamController", "../config", "../util/ecData", "zrender/tool/util", "zrender/config", "zrender/tool/event", "../util/mapData/params", "../util/mapData/textFixed", "../util/mapData/geoCoord", "../util/projection/svg", "../util/projection/normal", "../chart"], function (e) {
    ...
    var n = e("./base"), i = e("zrender/shape/Text"), a = e("zrender/shape/Path"), o = e("zrender/shape/Circle"), r = e("zrender/shape/Rectangle"), s = e("zrender/shape/Line"), l = e("zrender/shape/Polygon"), h = e("zrender/shape/Ellipse");
        ...
        type: m.CHART_TYPE_MAP, _buildShape: function () {
            ...
            for (var t, n, i, a, o = this.component.legend, r = {}, s = {}, l = {}, h = {}, V = 0, d = e.length; d > V; V++)if (e[V].type == m.CHART_TYPE_MAP && (e[V] = this.reformOption(e[V]), n = e[V].mapType, s[n] = s[n] || {}, s[n][V] = !0, l[n] = l[n] || e[V].mapValuePrecision, this._scaleLimitMap[n] = this._scaleLimitMap[n] || {}, e[V].scaleLimit && U.merge(this._scaleLimitMap[n], e[V].scaleLimit, !0), this._roamMap[n] = e[V].roam || this._roamMap[n], (null == this._hoverLinkMap[n] || this._hoverLinkMap[n]) && (this._hoverLinkMap[n] = e[V].dataRangeHoverLink), this._nameMap[n] = this._nameMap[n] || {}, e[V].nameMap && U.merge(this._nameMap[n], e[V].nameMap, !0), this._activeMapType[n] = !0, e[V].textFixed && U.merge(u, e[V].textFixed, !0), e[V].geoCoord && U.merge(y, e[V].geoCoord, !0), this._selectedMode[n] = this._selectedMode[n] || e[V].selectedMode, (null == this._hoverable[n] || this._hoverable[n]) && (this._hoverable[n] = e[V].hoverable), (null == this._clickable[n] || this._clickable[n]) && (this._clickable[n] = e[V].clickable), (null == this._showLegendSymbol[n] || this._showLegendSymbol[n]) && (this._showLegendSymbol[n] = e[V].showLegendSymbol), h[n] = h[n] || e[V].mapValueCalculation, t = e[V].name, this.selectedMap[t] = o ? o.isSelected(t) : !0, this.selectedMap[t])) {
                ...
                for (var p = 0, g = i.length; g > p; p++) {
                    a = this._nameChange(n, i[p].name), r[n][a] = r[n][a] || {seriesIndex: [], valueMap: {}};
            ...
            var i, a = this._mapDataMap[e].projection, o = [], r = this._mapDataMap[e].bbox || a.getBbox(t, this._specialArea[e]);
            ...
            if ("china" == e) {
                var p = this.geo2pos(e, y["南海诸岛"] || c["南海诸岛"].textCoord), g = i.scale.x / 10.5, b = [32 * g + p[0], 83 * g + p[1]];
            ...
            var r = e("../util/projection/normal"), s = r.getBbox(n), l = this.geo2pos(t, [a.left, a.top]), h = this.geo2pos(t, [a.left + a.width, a.top + a.height]), m = Math.abs(h[0] - l[0]), V = Math.abs(h[1] - l[1]), U = s.width, d = s.height, p = m / .75 / U, c = V / d;
            ...
            var i, a, o, r, s, l, h, m = this.series, V = this.zr.getWidth(), U = this.zr.getHeight(), d = Math.round(.02 * Math.min(V, U));
    ...
    return s.prototype = {
        type: "path", buildPathArray: function (e, t, n) {
            ...
            a === s && (c *= -1), isNaN(c) && (c = 0);
            var u = c * l * d / h, y = c * -h * U / l, g = (e + n) / 2 + Math.cos(V) * u - Math.sin(V) * y, b = (t + i) / 2 + Math.sin(V) * u + Math.cos(V) * y, f = r([1, 0], [(U - u) / l, (d - y) / h]), k = [(U - u) / l, (d - y) / h], x = [(-1 * U - u) / l, (-1 * d - y) / h], _ = r(k, x);
            ...
            for (var n = Number.MAX_VALUE, i = Number.MIN_VALUE, a = Number.MAX_VALUE, o = Number.MIN_VALUE, r = e.x || 0, s = e.y || 0, l = e.pathArray || this.buildPathArray(e.path), h = 0; h < l.length; h++)for (var m = l[h].points, V = 0; V < m.length; V++)V % 2 === 0 ? (m[V] + r < n && (n = m[V]), m[V] + r > i && (i = m[V])) : (m[V] + s < a && (a = m[V]), m[V] + s > o && (o = m[V]));
            var U;
    ...
    var n = e("./base"), i = e("zrender/shape/Text"), a = e("zrender/shape/Rectangle"), o = e("../util/shape/HandlePolygon"), r = e("../config");
    r.dataRange = {
        zlevel: 0,
        z: 4,
        show: !0,
    ...
    return t.prototype = {
        type: r.COMPONENT_TYPE_DATARANGE, _textGap: 10, _buildShape: function () {
            ...
            var e, t, n, o, r = this._valueTextList, s = r.length, l = this.getFont(this.dataRangeOption.textStyle), m = this._itemGroupLocation.x, V = this._itemGroupLocation.y, U = this.dataRangeOption.itemWidth, d = this.dataRangeOption.itemHeight, p = this.dataRangeOption.itemGap, c = h.getTextHeight("国", l);
            ...
            var t, n, o = this.getFont(this.dataRangeOption.textStyle), r = this._itemGroupLocation.x, s = this._itemGroupLocation.y, l = this.dataRangeOption.itemWidth, m = this.dataRangeOption.itemHeight, V = h.getTextHeight("国", o), U = 10, d = !0;
            ...
            var e, t, n = this._calculableLocation.x, i = this._calculableLocation.y, a = this._calculableLocation.width, r = this._calculableLocation.height, s = 5;
            ...
            var e, t, n, i, a, r, s, l, m = this._calculableLocation.x, V = this._calculableLocation.y, U = this._calculableLocation.width, d = this._calculableLocation.height, p = this.getFont(this.dataRangeOption.textStyle), c = h.getTextHeight("国", p), u = Math.max(h.getTextWidth(this._textFormat(this.dataRangeOption.max), p), h.getTextWidth(this._textFormat(this.dataRangeOption.min), p)) + 2;
            ...
            var e = this._valueTextList, t = e.length, n = this.dataRangeOption.itemGap, i = this.dataRangeOption.itemWidth, a = this.dataRangeOption.itemHeight, o = 0, r = 0, s = this.getFont(this.dataRangeOption.textStyle), l = h.getTextHeight("国", s), m = 10;
            ...
            var i = this._calculableLocation.x, a = this._calculableLocation.y, o = this._calculableLocation.width, r = this._calculableLocation.height;
            ...
            var t, n, i = this._calculableLocation.x, a = this._calculableLocation.y, o = this._calculableLocation.width, r = this._calculableLocation.height;
    ...
    var n = e("./base"), i = e("zrender/shape/Rectangle"), a = e("zrender/shape/Sector"), o = e("zrender/shape/Circle"), r = e("../config");
    r.roamController = {
        zlevel: 0,
        z: 4,
        show: !0,
    ...
    return t.prototype = {
        type: r.COMPONENT_TYPE_ROAMCONTROLLER, _buildShape: function () {
            ...
            n = 0 > n ? 20 : n;
            var i = Math.min(t / 2 - 5, n) / 2, a = this._itemGroupLocation.x + ("scaleDown" === e ? t - i : i), r = this._itemGroupLocation.y + this._itemGroupLocation.height - i, s = {
                zlevel: this.getZlevelBase(),
                z: this.getZBase(),
                style: {
                    x: a,
    ...
    function t(e) {
        ...
        for (var t = e.features, i = 0; i < t.length; i++)for (var a = t[i], o = a.geometry.coordinates, r = a.geometry.encodeOffsets, s = 0; s < o.length; s++) {
            var l = o[s];
            if ("Polygon" === a.geometry.type)o[s] = n(l, r[s]); else if ("MultiPolygon" === a.geometry.type)for (var h = 0; h < l.length; h++) {
                var m = l[h];
                l[h] = n(m, r[s][h])
            }
        }
    ...
    function n(e) {
        ...
        var i = t(n.getAttribute("x")), a = t(n.getAttribute("y")), o = t(n.getAttribute("width")), r = t(n.getAttribute("height"));
    ...
    var h = e("zrender/shape/Path"), m = {
        path: function (e, t) {
            ...
            var i = t(e.getAttribute("x")), a = t(e.getAttribute("y")), o = t(e.getAttribute("width")), r = t(e.getAttribute("height"));
            return {
                shapeType: "rectangle",
                x: i,
                y: a,
            ...
            var i = t(e.getAttribute("x1")), a = t(e.getAttribute("y1")), o = t(e.getAttribute("x2")), r = t(e.getAttribute("y2"));
            return {
                shapeType: "line",
                xStart: i,
                yStart: a,
    ...
    return {
        ...
        features: [{
            ...
            type: "Feature", id: "4453", properties: {name: "云浮市", cp: [111.7859, 22.8516], childNum: 5}, geometry: {
                type: "Polygon",
    ...
    return {
        type: "FeatureCollection", features: [{
            ...
            id: "2311",
            properties: {
                name: "黑河市", cp: [127.1448, 49.2957], childNum: 6
            },
            geometry: {
                type: "Polygon",
    ...
    return {
        ...
        features: [{
            ...
            type: "Feature", id: "4212", properties: {name: "咸宁市", cp: [114.2578, 29.6631], childNum: 6}, geometry: {
                type: "Polygon",
    ...
    return {
        ...
        features: [{
            ...
            type: "Feature", id: "2208", properties: {name: "白城市", cp: [123.0029, 45.2637], childNum: 5}, geometry: {
                type: "Polygon",
    ...
    return {
        ...
        features: [{
            ...
            type: "Feature", id: "5114", properties: {name: "眉山市", cp: [103.8098, 30.0146], childNum: 6}, geometry: {
                type: "Polygon",
    ...
    return {
        ...
        features: [{
            ...
            type: "Feature", id: "IRN", properties: {name: "Iran"}, geometry: {
                type: "Polygon",
    ...
    return {
        ...
        features: [{
            ...
            type: "Feature", id: "659004", properties: {name: "五家渠市", cp: [87.5391, 44.3024], childNum: 1}, geometry: {
                type: "Polygon", coordinates: ["@@çôÑlĕU»¥ÝUŗWkÛ@þVńÝĔ@ńÅþĶUX¦Æ"],
