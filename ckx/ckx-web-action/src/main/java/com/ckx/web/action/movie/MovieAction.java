package com.ckx.web.action.movie;
...
public class MovieAction extends BaseAction {
    ...
    public Object post(Movie vo, HttpServletRequest request, ModelMap model) {
    ...
    public Object put(Movie vo, HttpServletRequest request, ModelMap model) {
        Map<String, Object> result = getResultMap();
        try {
            if (vo.getId() == null) {
                result.put(RESULT, false);
