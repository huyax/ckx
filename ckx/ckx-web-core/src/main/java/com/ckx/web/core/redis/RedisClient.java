package com.ckx.web.core.redis;
...
public class RedisClient {
	...
	protected @Autowired StringRedisTemplate template;
	protected @Autowired RedisTemplate<Serializable, Serializable> redisTemplate;
